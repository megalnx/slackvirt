...
echo "  [separator]"
echo "  [exec]  (pause all) { /usr/local/etc/rc.d/rc.slackvirt pause }"
echo "  [exec]  (cont all) { /usr/local/etc/rc.d/rc.slackvirt resume }"
echo "  [separator]"
...
echo "  [submenu]  (acpi)"
echo "    [exec]  (powerdown) { slackware-qemu-vmserver.sh powerdown /usr/local/etc/slackvirt/server.qemu }"
echo "    [exec]  (reset) { slackware-qemu-vmserver.sh reset /usr/local/etc/slackvirt/server.qemu }"
echo "    [exec]  (wakeup) { slackware-qemu-vmserver.sh wakeup /usr/local/etc/slackvirt/server.qemu }"
echo "  [end]"
echo "  [separator]"
echo "  [exec]  (pause) { slackware-qemu-vmserver.sh pause /usr/local/etc/slackvirt/server.qemu }"
echo "  [exec]  (cont) { slackware-qemu-vmserver.sh resume /usr/local/etc/slackvirt/server.qemu }"
echo "  [separator]"
...
echo "  [submenu]  (acpi)"
echo "    [exec]  (powerdown) { slackware-qemu-vmserver.sh powerdown /usr/local/etc/slackvirt/desktop.qemu }"
echo "    [exec]  (reset) { slackware-qemu-vmserver.sh reset /usr/local/etc/slackvirt/desktop.qemu }"
echo "    [exec]  (wakeup) { slackware-qemu-vmserver.sh wakeup /usr/local/etc/slackvirt/desktop.qemu }"
echo "  [end]"
echo "  [separator]"
echo "  [exec]  (pause) { slackware-qemu-vmserver.sh pause /usr/local/etc/slackvirt/desktop.qemu }"
echo "  [exec]  (cont) { slackware-qemu-vmserver.sh resume /usr/local/etc/slackvirt/desktop.qemu }"
echo "  [separator]"
...
echo "  [exec]   (remote-viewer) {remote-viewer}"
echo "[separator]"
